            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Añadir</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                ...
                <form action="{{route('repositories.store')}}" method="POST" class="max-w-mg">
                    ...
                    <input class="form-input w-full rounded-md shadow-sm" type="text" name="url" value="">
